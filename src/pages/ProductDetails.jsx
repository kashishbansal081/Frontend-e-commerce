            ...
            <div className="productDetail d-flex flex-column flex-md-row">
              ...
              <div className="productData w-75 mt-4 mt-md-0 text-start ps-5">
                ...
                <div className="d-flex align-items-center mt-3">
                  ...
                  <span className="ms-2">({data.data.productRating})</span>
                </div>

                <div className="prices d-flex mt-2">
                  <h4 className="mt-1 fw-medium me-3">
                    Rs {data.data.productPrice}
                  </h4>
                  <h4 className="mt-1  text-decoration-line-through text-body-secondary">
                    Rs 80000
                  </h4>
                </div>
                <h4 className="mt-2 text-body-secondary fw-medium">29% off</h4>
                <div className="quantity d-flex align-items-center">
                  <p className="mt-4 fw-semibold me-3">Quantity:</p>
                ...
                <div className="highlights">
                  ...
                  <ul>
                    {data.data.productDescription.highlights.map((feature) => {
                ...
                <div className="delivery-Detail row text-center mt-3">
                  <div className="col-6 col-md-3 mb-3">
                    ...
                    />
                    <p className="mb-0 small">10 days Returnable</p>
                  </div>
                  <div className="col-6 col-md-3 mb-3">
                    <FontAwesomeIcon
                      ...
                      className="fa-2x mb-2"
                    />
                    <p className="mb-0 small">Pay Cash On Delivery</p>
                  </div>
                  <div className="col-6 col-md-3 mb-3">
                    <FontAwesomeIcon icon={faTruck} className="fa-2x mb-2" />
                    <p className="mb-0 small">Free Delivery</p>
                  </div>
                  <div className="col-6 col-md-3 mb-3">
                ...
                <div className="description">
                  <p className="mt-4 fw-semibold me-3">Description: </p>
                  <p>{data.data.productDescription.basic}</p>
                </div>
                <hr />
              </div>
            </div>
